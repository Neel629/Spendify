    ...
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex w-full flex-col justify-center px-8 sm:px-12 md:w-1/2 lg:px-24 xl:px-32">
        <div className="mx-auto w-full max-w-sm">
          <div className="mb-10">
            ...
            <p className="mt-2 text-base text-muted-foreground">Start tracking your expenses in seconds.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="full_name" name="full_name" type="text" placeholder="John Doe" required className="h-12 bg-transparent border-0 border-b border-border rounded-none px-0 focus-visible:ring-0 focus-visible:border-primary transition-colors text-base" />
            </div>
            ...
            <div className="text-center text-sm text-muted-foreground pt-4">
              ...
              <Link href="/login" className="font-semibold text-foreground hover:underline underline-offset-4 transition-all">
                Sign in
              </Link>
            </div>
          </form>
      ...
      <div className="hidden md:flex md:w-1/2 bg-[#FAFAFA] border-l border-border items-center justify-center p-12">
        <div className="max-w-lg">
          <div className="inline-block p-4 bg-black rounded-2xl shadow-sm border border-black mb-8">
          ...
          <p className="text-slate-600 text-lg">
            Stop guessing where your paycheck goes. Take control of your financial life today.
          </p>
        </div>
      </div>
    </div>
